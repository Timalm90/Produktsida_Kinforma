...
<head>
  ...
  <link rel="stylesheet" href="/stylesheet/header-desktop.css" />
...
<body>
  <header>
 <div class="header-container-desktop menu-glass-desk">

   <nav class="nav-left-desk">

  <a href="index.php">
    <img class="logo-header" src="/components/logo/Vector.png" alt="Kinforma logo" /></a>
...
<a href="#">Kontakt</a>
<a href="#">Vårt hållbarhetsarbete</a>
